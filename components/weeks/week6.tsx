  ...
  return (
    <div className="w-full max-w-3xl mx-auto p-5">
      <div className="space-y-1 mb-4">
        <div className="text-lg font-medium text-[#FFA500]">Week 6</div>
        <h2 className="text-2xl font-bold text-white">Git and Github</h2>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <h3 className="font-semibold mb-2 text-orange-500">Git</h3>
        ...
        <div>
          <h3 className="font-semibold mb-2 text-orange-500">Github</h3>
          <ul className="space-y-1">
